...
struct MiriGenmcShim : private GenMCDriver {
  ...
  private:
    ...
    /** Increment the event index in the given thread by `count` and return the new event. */
...
inline LoadResult from_value(SVal read_value) {
    return LoadResult { .consistent = true,
                        .error = std::unique_ptr<std::string>(nullptr),
                        .has_value = true,
...
inline LoadResult from_incons() {
    return LoadResult { .consistent = false,
                        .error = nullptr,
                        .has_value = false,
                        .read_value = GenmcScalarExt::uninit() };
}
...
inline StoreResult ok(bool is_coherence_order_maximal_write) {
    return StoreResult { .consistent = true,
                         .error = std::unique_ptr<std::string>(nullptr),
...
inline StoreResult from_incons() {
    return StoreResult { .consistent = false,
                         .error = nullptr,
                         .is_coherence_order_maximal_write = false };
}
} // namespace StoreResultExt
...
ok(SVal old_value, SVal new_value, bool is_coherence_order_maximal_write) {
    return ReadModifyWriteResult { .consistent = true,
                                   .error = std::unique_ptr<std::string>(nullptr),
...
inline ReadModifyWriteResult from_incons() {
    return ReadModifyWriteResult { .consistent = false,
                                   .error = nullptr,
                                   .old_value = GenmcScalarExt::uninit(),
                                   .new_value = GenmcScalarExt::uninit(),
                                   .is_coherence_order_maximal_write = false };
...
inline CompareExchangeResult success(SVal old_value, bool is_coherence_order_maximal_write) {
    return CompareExchangeResult { .consistent = true,
                                   .error = nullptr,
                                   .old_value = GenmcScalarExt::from_sval(old_value),
                                   .is_success = true,
                                   .is_coherence_order_maximal_write =
...
inline CompareExchangeResult from_incons() {
    return CompareExchangeResult { .consistent = false,
                                   .error = nullptr,
                                   .old_value = GenmcScalarExt::uninit(),
                                   .is_success = false,
                                   .is_coherence_order_maximal_write = false };
...
inline MutexLockResult ok(bool is_lock_acquired) {
    return MutexLockResult { .consistent = true,
                             .error = nullptr,
                             .is_reset = false,
...
inline MutexLockResult from_incons() {
    return MutexLockResult { .consistent = false,
                             .error = nullptr,
                             .is_reset = false,
                             .is_lock_acquired = false };
}
